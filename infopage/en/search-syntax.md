...
SeekR comes with a search syntax by with you can modify the categories,
...
SeekR supports the external bangs from [DuckDuckGo].  To directly jump to a
...
engine, SeekR cannot protect your privacy on this.
