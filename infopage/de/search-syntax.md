...
SeekR verfügt über eine Syntax mit der in einer Suchanfrage die Kategorien,
...
SeekR unterstützt die _external bangs_ von [ddg].  Das Präfix `!!` kann
...
SeekR kann die Privatsphäre des Benutzers in diesem Fall nur eingeschränkt
